...
if ($level > 1)
{
    if ($ussd_string_exploded[1] == "1")
    {
        ...
        showVideos($ussd_string_exploded);
    }
...
function showVideos($details){
    ...
    switch($count)
    {
        ...
        case 3:
            ...
            {
                //Daily
                ussd_stop("Thank you for subscribing to daily video service");
            }
            else if ($details[2] == "2")
            {
                ussd_stop("Thank you for subscribing to weekly video service");
            }
            else if($details[2] == "3")
            {
                ussd_stop("Thank you for subscribing to monthly video service");
            }
            break;
    }
